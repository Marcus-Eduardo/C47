...
var obsImg1, obsImg2, obsImg3, obsImg4, obsImg5;

function preload() {

  porta = loadImage("door.png");

  obsImg1 = loadImage("ball1.png");
  obsImg2 = loadImage("ball1.png");
  obsImg3 = loadImage("cubeWall14.png");
  obsImg4 = loadImage("cubeWall14.png");
  obsImg5 = loadImage("cubeWall13.png")

  imageFundo1 = loadImage("wall3.png");
  ...
  paredeImg14 = loadImage("cubeWall8.png");
  ...
  knightCorrendo = loadAnimation("knight4.png", "knight5.png");
  knightCorrendo.isPlaying = true
...
function setup() {
  ...
  boneco.addAnimation("correndo", knightCorrendo);
  boneco.scale = 0.1
...
function criarParedes() {
  ...
  parede14.addImage("paredeImg", paredeImg14);
  parede14.scale = 0.2
...
function criarObs() {
  ...
  obs5 = createSprite(345, 462, 5, 60);

  obs1.addImage(obsImg1);
  obs1.scale = 0.4

  obs2.addImage(obsImg2);
  obs2.scale = 0.4

  obs3.addImage(obsImg3);
  obs3.scale = 0.2
  console.log(obs3.width);

  obs4.addImage(obsImg4);
  obs4.scale = 0.2

  obs5.addImage(obsImg5);
  obs5.scale = 0.4
  ...
  obs1.setCollider("circle",0,0,30);
  obs2.setCollider("circle",0,0,30);
}
function ajustarLargura() {
  if (obs3.scale < 0.4 && aumentando) {
    obs3.scale += 0.005
  }
  if (obs3.scale > 0.1 && diminuindo) {
    obs3.scale -= 0.005
  }
  if (obs3.scale >= 0.4) {
    aumentando = false;
    diminuindo = true;
  } else if (obs3.scale <= 0.1) {
    aumentando = true;
    diminuindo = false;
  }
}